	...
	<header class="header">
		<div class="header-container">
			...
			<div class="header-actions">
				...
				<a href="login.jsp" class="btn-secondary login-btn"
					style="padding: 10px 20px;">Login</a> <a href="register.html"
					class="btn-primary register-btn" style="padding: 10px 20px;">Register</a>
